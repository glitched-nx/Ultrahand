...
const std::string projectName = "bluehand";
const std::string upperProjectName = "Bluehand";
...
const std::string ultrahandRepo = "https://github.com/glitched-nx/Bluehand-Overlay/";
